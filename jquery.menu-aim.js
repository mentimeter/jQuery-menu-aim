...
(function($) {
    ...
    $.fn.menuAim = function(option) {
        // Initialize menu-aim for all elements in jQuery collection
        this.each(function() {
            var $this   = $(this);
            var data    = $this.data('menuaim');
            var options = typeof option === 'object' && option;

            if (!data && /reset/.test(option)) return;
            if (!data) $this.data('menuaim', (data = new MenuAim(this, options)));
    ...
    MenuAim.prototype.init = function(element, options) {
        this.$menu = $(element),
        this.options = $.extend(MenuAim.DEFAULTS, options);
     ...
     */
    MenuAim.prototype.mouseenterRow = function(e) {
        if (this.timeoutId) {
    ...
    MenuAim.prototype.mouseleaveRow = function(e) {
     ...
     */
    MenuAim.prototype.clickRow = function(e) {
    ...
    MenuAim.prototype.reset = function(row) {
      this.activeRow = null;
    };
